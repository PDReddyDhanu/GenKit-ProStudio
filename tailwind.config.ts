    ...
    extend: {
      ...
      keyframes: {
        ...
        'card-in': {
         ...
         'lightning-flash': {
          '0%': { opacity: '0' },
          '2%': { opacity: '0.1', backgroundColor: '#fff' },
          '4%': { opacity: '0.5', backgroundColor: '#e0e7ff' },
          '6%': { opacity: '0.2' },
          '8%': { opacity: '1', backgroundColor: 'white', filter: 'blur(10px)' },
          '20%': { opacity: '0' },
          '100%': { opacity: '0' },
        },
        'title-reveal': {
          '0%': { opacity: '0', transform: 'scale(0.8) translateY(20px)', filter: 'blur(5px)' },
          '40%': { opacity: '0', transform: 'scale(0.8) translateY(20px)', filter: 'blur(5px)' },
          '70%': { opacity: '0.8', transform: 'scale(1.05) translateY(0)', filter: 'blur(0)' },
      ...
      animation: {
        ...
        'lightning-flash': 'lightning-flash 2.5s ease-out infinite',
