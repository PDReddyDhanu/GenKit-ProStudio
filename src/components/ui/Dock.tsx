...
function DockIcon({ children, className = '' }: DockIconProps) {
  return <div className={`flex items-center justify-center text-primary ${className}`}>{children}</div>;
}
...
export default function Dock({
  ...
  magnification = 70,
  distance = 100, // Reduced distance for tighter magnification effect
  panelHeight = 68,
  dockHeight = 80, // Reduced from 256
  baseItemSize = 50
}: DockProps) {
