...
export default function GeneratedImages() {
    ...
    const imageUrl = currentHackathon?.summaryImageUrl;

    return (
        <Card>
            <CardHeader>
                <CardTitle className="font-headline">Generated Summary Image</CardTitle>
                <CardDescription>A summary image of the hackathon's statistics and spirit, generated by AI.</CardDescription>
            </CardHeader>
            <CardContent>
                {imageUrl ? (
                    <div className="relative aspect-video w-full">
                        <Image 
                            src={imageUrl} 
                            alt={`${currentHackathon?.name} summary image`}
                            fill
                    ...
                    <div className="flex flex-col items-center justify-center h-64 border-2 border-dashed rounded-lg">
                        ...
                        <p className="mt-4 text-muted-foreground">No image has been generated for this hackathon yet.</p>
